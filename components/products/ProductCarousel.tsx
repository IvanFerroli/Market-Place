  ...
  return (
    <div className="relative">
      ...
      <button
        ...
        disabled={!canLeft}
        className="absolute left-2 top-1/2 -translate-y-1/2 rounded-full border text-black bg-[color:var(--cp-yellow)]
rounded-full text-black border bg-[color:var(--cp-yellow)]
 p-2 shadow-sm transition disabled:opacity-40"
      >
        ←
      </button>
      ...
      <button
        ...
        onClick={() => scrollByDir(1)}
        disabled={!canRight}
        className="absolute right-2 top-1/2 -translate-y-1/2 rounded-full border text-black bg-[color:var(--cp-yellow)]
rounded-full text-black border bg-[color:var(--cp-yellow)]
 p-2 shadow-sm transition disabled:opacity-40"
      >
        →
